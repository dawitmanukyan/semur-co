          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <?php echo '<a class="nav-main-link" href="Categories.php?h='.$_GET['h'].'">' ?>
                      <span class="nav-main-link-name">Կայքում առկա կածեգորյաները</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                  ...
                  <li class="nav-main-item">
                    <?php echo '<a class="nav-main-link" href="Subcategories.php?h='.$_GET['h'].'">' ?>
                      <span class="nav-main-link-name">Կայքում առկա ենթակածեգորյաները</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <?php echo '<a class="nav-main-link" href="Add-subcategories.php?h='.$_GET['h'].'">' ?>
                      <span class="nav-main-link-name">Ավելացնել ենթակածեգորյա</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                  <?php echo' <a class="nav-main-link active" href="Blog.php?h='.$_GET['h'].'"> '; ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-boxed">
          ...
          <div class="row">
            <!-- Story -->
            <?php
              $imgs = $mysql -> query("SELECT * FROM `blogs`");

              foreach($imgs as $value){
                echo '<div class="col-lg-6"  style="text-align: center;">
                  <div class="block block-rounded block-link-pop overflow-hidden" href="/img-blog/'.$value['img'].'">
                    <img class="img-fluid" src="img-blog/'.$value['img'].'" alt="">
                    ...
                    <a href="Delete.php?h='.$_GET['h'].'&id='.$value['id'].'&type=blogs&file=Blog.php"><button class="btn btn-danger" style="margin:5px;">Ջնջել</button></a>
                  </div>
                </div>';
              }
            ?>
