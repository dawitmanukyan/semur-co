                  ...
                  <?php
                      ...
                      foreach($asr as $value){
                        ...
                        foreach($asr0 as $value){
                          echo '<a href="Apranq-en.php?id='.$value['id'].'" style="color: #EF4B37;"><li style="margin-left: 30px;">
                            '.$value['nameeng'].'
                          </li></a>';
                        }
                        ...
                        foreach($asr1 as $value){
                          echo '<ul style="margin-left: 30px;">
                            ...
                            foreach($asr0 as $value){
                              echo '<a href="Apranq-en.php?id='.$value['id'].'" style="color: #EF4B37;"><li style="margin-left: 50px;">
                                '.$value['nameeng'].'
                              </li></a>';
                            }
                            $asr1 = $mysql -> query("SELECT * FROM `subcategories` WHERE `incategory`=$is");
